...
import eo from "../../../../Img/aff/eo.png";
import useStyles from "./BossesStyles";

const SludgefistComponent = () => {
  const classes = useStyles();
  return (
    <Grid container xs={12} direction="column" className={classes.aligned}>
      {" "}
      <Typography className={classes.tittle}>Sludgefist</Typography>
      ...
      <Grid container className={classes.justify}>
        {/* <a
          href="https://www.wowhead.com/item=180117/empyreal-ordnance?bonus=6805:1472"
      ...
      <Grid container justify="center" className={classes.imgBorder}>
        <img src={Sludgefist} alt="" className={classes.imgBorder} />
      </Grid>
    </Grid>
  );
};

export default SludgefistComponent;
