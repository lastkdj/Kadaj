...
const HuntsmanComponent = () => {
  const classes = useStyles();
  return (
    <Grid container xs={12} direction="column" className={classes.aligned}>
      {" "}
      <Typography className={classes.tittle}>Huntsman Altimore</Typography>
      ...
      <Grid container className={classes.justify}>
        <img src={Huntsman} alt="" className={classes.imgBorder} />
      </Grid>
    </Grid>
  );
};

export default HuntsmanComponent;
