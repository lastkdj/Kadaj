...
const SunskingComponent = () => {
  const classes = useStyles();
  return (
    <Grid container xs={12} direction="column" className={classes.aligned}>
      {" "}
      <Typography className={classes.tittle}>Sun King's Salvation</Typography>
      ...
      <Grid container justify="center" className={classes.imgBorder}>
        <img src={Sunsking} alt="" className={classes.imgBorder} />
      </Grid>
    </Grid>
  );
};

export default SunskingComponent;
